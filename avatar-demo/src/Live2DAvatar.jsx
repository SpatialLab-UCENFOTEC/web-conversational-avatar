...
const Live2DAvatar = forwardRef(function Live2DAvatar(_, ref) {
  ...
  useEffect(() => {
    ...
    // ✅ CRÍTICO: registrar el Ticker ANTES de cargar cualquier modelo
    ...
    const init = async () => {
      try {
        ...
        // ✅ Evitar montar dos veces (React StrictMode)
        ...
        model.on("pointertap", () => {
          try { model.motion("touch_01"); } catch {}
        });
        ...
        try { model.motion("idle_01"); } catch {}
      } catch (err) {
